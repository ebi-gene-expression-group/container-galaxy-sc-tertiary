...
class KubernetesJobRunner(AsynchronousJobRunner):
    ...
    def check_watched_item(self, job_state):
        ...
        if len(jobs.response['items']) == 1:
            ...
            # Check if job.obj['status'] is empty, return job_state unchanged if this is the case
            # as probably this means that the API server hasn't have time to fill in the object status
